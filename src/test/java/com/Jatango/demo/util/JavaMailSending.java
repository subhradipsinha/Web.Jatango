	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("subhradip.sinha@gmail.com", "Subhradip@1989");
			}
		});
		// compose message
		try {
		...
		try {
			...
			msg.setFrom(new InternetAddress("subhradip.sinha@ncompasbusiness.com", "subhradip.sinha@gmail.com"));

			msg.setReplyTo(InternetAddress.parse("subhradip.sinha@gmail.com", false));
			...
			String filename = System.getProperty("user.dir")
					+ "Reports/Jatango.html"+"Reports/Jatango.pdf";
			...
			File f = new File(System.getProperty("user.dir") + "Reports/Jatango.html"+"Reports/Jatango.pdf");

			// Populates the array with names of files and directories
			String[] myFiles = f.list();
			String path = System.getProperty("user.dir") + "Reports/Jatango.html"+"Reports/Jatango.pdf";
